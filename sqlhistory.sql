...
col CPU for 9999,99999999999999999
...
begin
	...
	for phv in get_phv('&&V_SQL_ID', :v_nbr_days) loop
		...
		dbms_output.put_line('|'||
			...
			rpad(trim(to_char(phv.sum_cpu_time,'999,999,9999,999990.00')),12,' ')||
			rpad(trim(to_char(phv.sum_elapsed_time,'999,999,999,999990.00')),12,' ')||'|');
		--
